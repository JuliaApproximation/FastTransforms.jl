...
function Base.A_mul_B!(f::AbstractVector{T}, P::NUFFTPlan{1,T}, c::AbstractVector{T}) where T
...
function Base.A_mul_B!(F::Matrix{T}, P::NUFFTPlan{N,T}, C::Matrix{T}) where {N,T}
    for J = 1:size(F, 2)
...
function Base.A_mul_B!(f::AbstractVector{T}, P::NUFFTPlan{2,T}, c::AbstractVector{T}) where T
    U, V, p, t, temp, temp2, Ones = P.U, P.V, P.p, P.t, P.temp, P.temp2, P.Ones
...
function Base.A_mul_B!(f::AbstractVector{T}, P::NUFFTPlan{3,T}, c::AbstractVector{T}) where T
    U, V, p, t, temp, temp2, Ones = P.U, P.V, P.p, P.t, P.temp, P.temp2, P.Ones
...
function Base.A_mul_B!(F::Matrix{T}, P::NUFFT2DPlan{T}, C::Matrix{T}) where T
